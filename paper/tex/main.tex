...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figure2_transition.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figure1_architecture.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{figure3_performance.png}
